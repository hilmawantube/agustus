...
echo
"\e[32;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ \n";
echo "\e[31;1m===========\e[93mHILMAWAN TUBE\e[31;1m=============\n";
echo "\e[32;1m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
echo color("yellow","[✓] MASUKIN TOKENYA: ");
$token = trim(fgets(STDIN));
echo "\n".color("yellow","[?] Mau Redeem Voucher?: y/n ");
        $pilihan = trim(fgets(STDIN));
        if($pilihan == "y" || $pilihan == "Y"){
        echo color("green","=============AUTO CLAIM VOC 15K=================");
        echo "\n".color("green"," [Food] VOCER 15K");
        ...
        echo "\n".color("red","Message: ".$message);
        echo "\n".color("green"," [Claim] ULANG BIAR JOSS");
        echo "\n".color("yellow","▶SabarYa");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(10);
